...
typedef void (*gllc_WN_size_cb)(struct gllc_WN *w, int width, int height,
                                void *USER_1);
typedef void (*gllc_WN_mouse_move_cb)(struct gllc_WN *w, int x, int y,
                                      void *USER_1);
typedef void (*gllc_WN_mouse_click_cb)(struct gllc_WN *wn, int x, int y,
                                       int mode, int action, void *USER_1);
typedef void (*gllc_WN_mouse_scroll_cb)(struct gllc_WN *wn, int dx, int dy,
                                        void *USER_1);
