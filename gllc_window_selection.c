...
void gllc_W_selection_draw(struct gllc_W_selection *sel, GLuint u_color_loc,
  ...
  GLfloat V[] = {(GLfloat)x0, (GLfloat)y0, (GLfloat)x1, (GLfloat)y0,
                 (GLfloat)x1, (GLfloat)y1, (GLfloat)x0, (GLfloat)y1};
  ...
  glDrawElements(GL_TRIANGLES, SEL_RECT_ICOUNT, GL_UNSIGNED_INT,
                 (void *)(sizeof(GLuint) * SEL_LINES_ICOUNT));
}