...
typedef void (*gllc_block_ent_build_cb)(struct gllc_block_entity *, double,
                                        struct gllc_DBD *);
typedef void (*gllc_block_ent_destroy_cb)(struct gllc_block_entity *);
typedef int (*gllc_block_ent_bbox_cb)(struct gllc_block_entity *, double,
                                      double *, double *, double *, double *);
typedef int (*gllc_block_ent_picked_cb)(struct gllc_block_entity *, double,
                                        double, double);
typedef int (*gllc_block_ent_selected_cb)(struct gllc_block_entity *, double,
                                          double, double, double, double);
...
#define GLLC_ENT_SET_FLAG(ent, fl)                                             \
  (((struct gllc_block_entity *)ent)->flags |= (fl))
#define GLLC_ENT_UNSET_FLAG(ent, fl)                                           \
  (((struct gllc_block_entity *)ent)->flags &= ~(fl))
...
void gllc_ent_set_layer(struct gllc_block_entity *ent,
                        struct gllc_layer *layer);
...
void gllc_ent_build(struct gllc_block_entity *ent, double scale,
                    struct gllc_DBD *DBD);

int gllc_ent_bbox(struct gllc_block_entity *ent, double scale, double *x0,
                  double *y0, double *x1, double *y1);

int gllc_ent_picked(struct gllc_block_entity *ent, double scale, double x,
                    double y);
